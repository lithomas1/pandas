...
with zipfile.ZipFile(repaired_wheel_path, "a") as zipf:
    try:
        ...
        zipf.write(os.path.join(base_redist_dir, "msvcp140.dll"), "pandas/_libs/window/msvcp140.dll")
        zipf.write(os.path.join(base_redist_dir, "concrt140.dll"), "pandas/_libs/window/concrt140.dll")
        if not is_32:
            zipf.write(os.path.join(base_redist_dir, "vcruntime140_1.dll"), "pandas/_libs/window/vcruntime140_1.dll")
